...
class OrderCancelledHandlerTest {
    ...
    @Test
    void handle_shouldCancelValidatedOrderAndReleaseInventory() {
        ...
        String payload = """
            {"orderId":"order-1","reason":"USER_REQUEST"}
            """;
    ...
    @Test
    void handle_shouldDoNothingWhenOrderIsShipped() {
        Order order = Order.restore(
            "order-1",
            "wh-1",
            Status.SHIPPED,
    ...
    @Test
    void handle_shouldReleaseAgainWhenAlreadyCanceled() {
        Order order = Order.restore(
            "order-1",
            "wh-1",
            Status.CANCELED,
