...
Esto si es E2E porque no se queda en la respuesta inicial: espera el cambio real producido por outbox, EventBridge, SQS, worker y servicios desplegados.
...
Necesitas JDK 17. Si `java -version` muestra Java 8 o `javac` no existe, Maven no podra compilar.
