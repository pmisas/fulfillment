package com.fulfillment.shippingservice.resilience;
...
import com.fulfillment.shippingservice.infrastructure.rest.GlobalExceptionHandler;

class ShippingGlobalExceptionHandlerResilienceTest {
    ...
    @CsvSource({
        ...
        "s3,Shipping guide storage unavailable",
        "pdf,Shipping guide PDF generation failed",
    ...
    private static class FailingDependencyController {
        ...
        void fail(@PathVariable String failure) {
            throw new RuntimeException(switch (failure) {
                ...
                case "s3" -> "Shipping guide storage unavailable";
                case "pdf" -> "Shipping guide PDF generation failed";
